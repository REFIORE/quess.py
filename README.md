...
Запрашивает у пользователя букву, проверяет правильнось его ввода (одна буква латинского алфавита) и чтобы не повторялись ранее названные буквы. Если все условия выполнены, то возвращает букву, иначе вернёт - `None`
